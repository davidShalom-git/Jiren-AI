  ...
  return (
    ...
    <div className="container">
        <div className="row d-flex justify-content-between">
          <div className="col border border-dark mt-4 p-4 mx-md-4">
          ...
          <div className="col ms-3 mt-4 p-5 border border-dark d-flex justify-content-center">
             <div className='row'>
                <img src={designer} height="380px" />
             </div>
          </div>
        </div>
    </div>
    ...
    <div className="container mt-5">
        <div className="row d-flex justify-content-between">
          <div className="col-12 col-md-5 border border-dark mt-4 p-4 mx-md-4">
          ...
          <div className=" col-12 col-md-6  border border-dark mt-4 p-4">
   ...
   <div className='container'>
    <div className="row">
        <div className='col-12 col-md-6 border border-dark p-3 d-flex justify-content-center'>
                <img  src={goku} height="400px" />
        </div>
        <div className='col-12 col-md-5 border border-dark p-3  d-flex justify-content-center mx-md-3'>
                <img  src={Broly} height="400px"/>
        </div>
        <div className='col-12 col-md-6 mt-3 border border-dark p-3 d-flex justify-content-center'>
                <img  src={whis} height="400px" />
        </div>
        <div className='col-12 col-md-5 border mt-3 border-dark p-3  d-flex justify-content-center mx-md-3'>
                <img  src={Beerus} height="400px"/>
        </div>
    </div>
   </div>
